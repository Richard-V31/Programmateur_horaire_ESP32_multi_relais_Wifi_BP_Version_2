...
//  (unique, sans espace, ex: "Re..") et la broche GPIO. Pour en retirer un,
...
struct Programmateur {
  const char* id;        // Identifiant unique utilisé dans les routes web et le stockage NVS (court, sans espace -> Ex: Re8)
...
//
//  🔘 Bouton poussoir de forçage physique (optionnel, uniquement câblé ici sur Re1 à Re4) :
...
Programmateur programmateurs[] = {
  { "Re1", "Programmation 1", "Cuisine",  "#f59e0b", 32, "08:05", "12:00", true, false, 14 }, //#f59e0b est un code couleur hexadécimal R V B
  { "Re2", "Programmation 2", "Portail",  "#06b6d4", 33, "12:00", "13:15", true, false, 16 },
  { "Re3", "Programmation 3", "Relais 3", "#0CE892", 25, "14:00", "16:26", true, false, 17 },
  { "Re4", "Programmation 4", "Relais 4", "#ef4444", 26, "22:00", "04:15", true, false, 18 },
  ...
  // { "Re5",  "Programmation 5",  "Relais 5",  "#a78bfa", 27, "12:00", "22:00", true, false, -1 },
  // { "Re6",  "Programmation 6",  "Relais 6",  "#f472b6", 14, "13:00", "23:00", true, false, -1 },
  // { "Re7",  "Programmation 7",  "Relais 7",  "#38bdf8", 12, "07:00", "17:00", true, false, -1 },
  // { "Re8",  "Programmation 8",  "Relais 8",  "#fbbf24", 13, "06:00", "16:00", true, false, -1 },
};
...
//  dynamiquement à partir de l'id de chaque programmateur (ex: "Re1debut"),
...
//  "Rexx") et des suffixes courts ("debut","fin","auto","etM"), on reste
...
// ============================================================================
//  🔘 BOUTONS POUSSOIRS DE FORÇAGE PHYSIQUE (Re1 à Re4 uniquement)
// ============================================================================
