...
![Release](https://img.shields.io/badge/Release-v1.0.et.OTA-orange)
...
Programmateur programmateurs[] = {
  { "Re1", "Programmation 1", "Cuisine",  "#f59e0b", 32, "08:05", "12:00", true, false, 14 },
...
- **Aucune authentification** : toute personne connectée au même réseau WiFi peut piloter les relais depuis l'interface web. À garder en tête si l'un des relais commande un équipement sensible (portail, alarme...).
- **Pas de mise à jour par WiFi (OTA)** : les mises à jour du programme nécessitent un branchement USB.
